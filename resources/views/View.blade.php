                ...
                <form class="" action="" style="width:60rem">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="john.doe@gmail.com" aria-label="email"
                            name="email" aria-describedby="basic-addon1" disabled>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="+965-50923840" aria-label="phone"
                            name="phone" aria-describedby="basic-addon1" disabled>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Address</span>
                        <textarea class="form-control" name='address' aria-label="With textarea" disabled></textarea>
                    </div>
